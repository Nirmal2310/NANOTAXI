    ...
    column(
      ...
      wellPanel(
        ...
        conditionalPanel(
          ...
          selectInput("pipeline", "Select Analysis Tool", choices = list("KRAKEN2", "Minimap2"),
                      selected = "Minimap2"),
          selectInput("database", "Select Database", choices = list("GTDB", "MIMT", "GSR", "REFSEQ"),
                      selected = "REFSEQ"),
        ...
        conditionalPanel(
          ...
          selectInput("pipeline", "Select Analysis Tool", choices = list("EMU + Standard DB", "BLASTn", "Kraken2", "Minimap2"),
                      selected = "EMU + Standard DB"),
          selectInput("database", "Select Database", choices = list("GTDB", "MIMT", "GSR", "REFSEQ"),
                      selected = "REFSEQ"),
